...
================
*/
CmHandle idCollisionModelManagerLocal::SetupTrmModel( const idTraceModel &trm, const idMaterial *material ) {
	int i, j;
	cm_vertex_t *vertex;
	cm_edge_t *edge;
	cm_polygon_t *poly;
...
================
*/
CmHandle idCollisionModelManagerLocal::FindModel( const char *name ) {
	int i;
...
================
*/
void idCollisionModelManagerLocal::ModelInfo( CmHandle model ) {
...
===================
*/
const char *idCollisionModelManagerLocal::GetModelName( CmHandle model ) const {
...
===================
*/
bool idCollisionModelManagerLocal::GetModelBounds( CmHandle model, idBounds &bounds ) const {
...
===================
*/
bool idCollisionModelManagerLocal::GetModelContents( CmHandle model, int &contents ) const {
	if ( model < 0 || model > MAX_SUBMODELS || model >= numModels || !models[model] ) {
...
===================
*/
bool idCollisionModelManagerLocal::GetModelVertex( CmHandle model, int vertexNum, idVec3 &vertex ) const {
	if ( model < 0 || model > MAX_SUBMODELS || model >= numModels || !models[model] ) {
...
===================
*/
bool idCollisionModelManagerLocal::GetModelEdge( CmHandle model, int edgeNum, idVec3 &start, idVec3 &end ) const {
	if ( model < 0 || model > MAX_SUBMODELS || model >= numModels || !models[model] ) {
...
===================
*/
bool idCollisionModelManagerLocal::GetModelPolygon( CmHandle model, int polygonNum, idFixedWinding &winding ) const {
	int i, edgeNum;
	cm_polygon_t *poly;
...
==================
*/
CmHandle idCollisionModelManagerLocal::LoadModel( const char *modelName, const bool precache ) {
	int handle;
